...
function App() {
  return (
    <div className="App home_container container flex__col">
      <div className="main">
        <div className="intro">
          <h2>
          ...
          <div className="cta">
            <p className="cta__p">
              ...
              creative arts and craft designer looking to expand your scope and
              get more people to know about your work and get to buy from you.{" "}
              <br />
              if you are not a designer but love our products, we still
              encourage to sign up for an account as a regular customer so that
              you can be benefiting from our bonuses.
            </p>
